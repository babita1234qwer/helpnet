        ...
        {isAuthenticated?(<Dropdown placement="bottom-end">
          <DropdownTrigger>
            <Avatar
              ...
              name="HelpNet User"
              size="sm"
              src="https://i.pravatar.cc/150?u=user" className="w-12 h-12 rounded-full border border-gray-300"></Avatar>
          </DropdownTrigger>
...
<section className=" hero-section  w-full bg-gray-900 text-white py-48 px-6 text-center">
  ...
  <h3 className="text-2xl md:text-3xl font-medium leading-snug continuous-fade continuous-fade-delay-3">
